...
\begin{sol}
	...
	\end{align*}
	Ahora vamos a analizar la expresión $\displaystyle\sum_{n>x}\frac{\chi(n)}{\sqrt{n}}$.\\
...
\begin{sol}
	...
	\end{align*}
	Se sabe que $\displaystyle \sum_{p\leq x}\frac{\chi(p)\log p}{p}=O_\chi\paren{1}$, con lo cual se ve lo siguiente
	\begin{align*}
